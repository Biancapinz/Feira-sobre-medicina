...
$host = 'localhost';
$usuario = 'root';
$senha = 'sua_senha'; // ⬅️ Substitua pela senha real do seu MySQL
...
<head>
  ...
  <link rel="stylesheet" href="seu-estilo.css"> <!-- Se quiser estilizar -->
  <style>
  ...
  <?php else: ?>
    ...
    <form method="post">
      ...
      <select name="idhospital" required>
        <option value="1">Hospital de Clínicas</option>
        <option value="2">Hospital Moinhos de Vento</option>
        <option value="3">Hospital Mãe de Deus</option>
        <!-- Adapte conforme IDs reais da tabela hospitais -->
      </select>
...
<!-- RODAPÉ -->
<!-- ============================== -->
<footer style="text-align: center; padding: 20px; background